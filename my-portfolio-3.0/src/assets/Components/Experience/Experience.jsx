...
function Experience({expContents}) {
  return (
    <>
        ...
        <div className="mt-20 py-20 px-10 text-white">
            {/* GRID-CONTAINER */}
            <div className="grid gap-10 grid-cols-[repeat(auto-fit,minmax(220px,1fr))]">
                {expContents.map((expContent,index)=>{return (
                    <div id="projects" className="bg-gray-900 rounded-2xl px-4 py-6 shadow-md shadow-gray-600" key={index}>
                        <h1 className='text-3xl mb-2'><CountUp suffix="+" end={expContent.number}/></h1>
