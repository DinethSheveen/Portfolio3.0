...
function Contact3D() {
  ...
  return (
    <Canvas camera={{position:[0,0,25], fov:45, near:0.1, far:1000}}>
          {/* LIGHTINGS */}
          <directionalLight position={[4,5,2]} color="white" intensity={10}/>
          <spotLight position={[-1,0.2,-4]} color="orange" penumbra={0.8} angle={0.8} intensity={15}/>
          <spotLight position={[4,-1,-4]} color="red" penumbra={2} angle={0.8} intensity={15}/>
          ...
          <group
          scale={0.04}
          position={isMobile?[0.5,-2,1]:[0.2,-2,1]}
          rotation={[0.1,3.2,0]}
          >
            {/* 3D MODEL */}
            <ContactModel/>
